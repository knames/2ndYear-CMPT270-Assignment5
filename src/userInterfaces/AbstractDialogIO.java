...
/**
 * A partially implemented class with the input and output methods to 
 * read a String, read an int, output a message, and display a list 
 * of choices from which the user must select the index of a choice.  
 * The input and output is done via dialog boxes.
 */
